...
(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        */
        that.setValue = function (sc, fill, time, temp) {
            ...
            v =  "未填写";
            state = $('.dw-state .dwwl0 .dw-sel').attr("data-val");
            ...
            if (!temp) {
                ...
                that.val = v;
                // console.log($('#info_state').html());
                // that.html += "span class="meta-sex c-blue"><i class="fa fa-mars"></i></span>";
            }

            if (fill) {
                if (input) {
                    // if(sex == 2015) {$('#info_state').parent().html('<p><span>性别</span></p><input id="info_state"  value ="男"  class="bounceOutUp"  ></input> <span class="meta-sex c-blue"><i class="fa fa-mars"></i></span>');}
        ...
        */
        ...
        that.fadeIn =function () {
          ...
          $('.dw-state .dwo').fadeIn(300,function(){
            ...
            console.log($('.dw-state .dwwl0 .dw-bf').children().eq(1).children().html());
            $(".dw-state .dwwl0 .dw-bf").children().eq(0).children().text('未填写');
            $(".dw-state .dwwl0 .dw-bf").children().eq(1).children().text('你猜');
            $(".dw-state .dwwl0 .dw-bf").children().eq(2).children().text('单身');
            $(".dw-state .dwwl0 .dw-bf").children().eq(3).children().text('非单身');
    ...
    $.fn.mobiscroll2 = function (method) {
        extend(this, $.mobiscroll2.shorts);
        return init(this, method, arguments);
    };

    $.mobiscroll2 = $.mobiscroll2 || {
        /**
